        ...
        <AppBar position="static" sx={{ background: 'linear-gradient(to right, #7B68EE, rgb(28, 0, 53))', boxShadow: 'none' }}>
          <Toolbar>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={3} sx={{ placeItems: 'center', display: { xs: 'flex', lg: 'none', cursor: 'pointer' }, justifyContent: 'start' }} onClick={HomeButton}>
                <img src={logoImageXs} alt='LOGO' style={{ width: '15%', maxHeight:'20%', alignItems: 'center' }} />
              </Grid>
